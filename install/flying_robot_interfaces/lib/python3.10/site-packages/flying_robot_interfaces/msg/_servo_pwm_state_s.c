...
bool flying_robot_interfaces__msg__servo_pwm_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flying_robot_interfaces.msg._servo_pwm_state.ServoPWMState", full_classname_dest, 58) == 0);
  }
  flying_robot_interfaces__msg__ServoPWMState * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ServoPWMState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flying_robot_interfaces.msg._servo_pwm_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoPWMState");

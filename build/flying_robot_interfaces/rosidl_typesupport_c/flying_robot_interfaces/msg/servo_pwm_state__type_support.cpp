...
static const _ServoPWMState_type_support_symbol_names_t _ServoPWMState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flying_robot_interfaces, msg, ServoPWMState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flying_robot_interfaces, msg, ServoPWMState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flying_robot_interfaces, msg, ServoPWMState)() {
  return &::flying_robot_interfaces::msg::rosidl_typesupport_c::ServoPWMState_message_type_support_handle;
}
